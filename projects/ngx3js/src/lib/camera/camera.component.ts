...
export class CameraComponent extends AbstractObject3dComponent implements OnInit {
   ...
   * Input  of camera component
   */
  @Input() public referObject3d: AbstractObject3dComponent | THREE.Object3D = null;
              ...
              switch (this.viewportType.toLowerCase()) {
                ...
                case 'offset':
                  if (this.camera instanceof THREE.PerspectiveCamera || this.camera instanceof THREE.OrthographicCamera) {
                    this.camera.setViewOffset(this.fullWidth, this.fullHeight, this.getX(), this.getY(), this.getWidth(), this.getHeight());
                  }
                  break;
                case 'viewport':
                case 'camera':
                  if (this.camera instanceof THREE.PerspectiveCamera) {
                    (this.camera as any)['viewport'].set(this.getX(), this.getY(), this.getWidth(), this.getHeight()).multiplyScalar(this.pixelRatio);
                  }
                  break;
              }
            }
    ...
    if (this.camera === null || this._needUpdate) {
      ...
      switch (this.type.toLowerCase()) {
        ...
        case 'pingpong':
          ...
          const cubeCamera1 = new THREE.CubeCamera(this.getNear(0.1), this.getFar(2000), webGLCubeRenderTarget1);
          ...
          const cubeCamera2 = new THREE.CubeCamera(this.getNear(0.1), this.getFar(2000), webGLCubeRenderTarget2);
        ...
        case 'perspective':
        default:
          const perspectiveCamera: any = new THREE.PerspectiveCamera(this.getFov(50), this.getAspect(width, height), this.getNear(0.1), this.getFar(2000));
