...
export interface ITubeBufferGeometry extends IBufferGeometry {
    /**
...
export interface IObjectLoader extends ILoader {
    ...
    parseGeometries(json: any): { [key: string]: IInstancedBufferGeometry | IBufferGeometry }; // Array of BufferGeometry or Geometry or Geometry2.
...
export interface ILightProbe extends ILight {
    ...
    fromJSON(json: object): ILightProbe;
}
...
export const CullFaceNone: THREE.CullFace = THREE.CullFaceNone;
export const CullFaceBack: THREE.CullFace = THREE.CullFaceBack;
export const CullFaceFront: THREE.CullFace = THREE.CullFaceFront;
export const CullFaceFrontBack: THREE.CullFace = THREE.CullFaceFrontBack;
export const BasicShadowMap: THREE.ShadowMapType = THREE.BasicShadowMap;
export const PCFShadowMap: THREE.ShadowMapType = THREE.PCFShadowMap;
export const PCFSoftShadowMap: THREE.ShadowMapType = THREE.PCFSoftShadowMap;
export const VSMShadowMap: THREE.ShadowMapType = THREE.VSMShadowMap;
export const FrontSide: THREE.Side = THREE.FrontSide;
export const BackSide: THREE.Side = THREE.BackSide;
export const DoubleSide: THREE.Side = THREE.DoubleSide;
export const FlatShading: THREE.Shading = THREE.FlatShading;
export const SmoothShading: THREE.Shading = THREE.SmoothShading;
export const NoBlending: THREE.Blending = THREE.NoBlending;
export const NormalBlending: THREE.Blending = THREE.NormalBlending;
export const AdditiveBlending: THREE.Blending = THREE.AdditiveBlending;
export const SubtractiveBlending: THREE.Blending = THREE.SubtractiveBlending;
export const MultiplyBlending: THREE.Blending = THREE.MultiplyBlending;
export const CustomBlending: THREE.Blending = THREE.CustomBlending;
export const AddEquation: THREE.BlendingEquation = THREE.AddEquation;
export const SubtractEquation: THREE.BlendingEquation = THREE.SubtractEquation;
export const ReverseSubtractEquation: THREE.BlendingEquation = THREE.ReverseSubtractEquation;
export const MinEquation: THREE.BlendingEquation = THREE.MinEquation;
export const MaxEquation: THREE.BlendingEquation = THREE.MaxEquation;
export const ZeroFactor: THREE.BlendingDstFactor = THREE.ZeroFactor;
export const OneFactor: THREE.BlendingDstFactor = THREE.OneFactor;
export const SrcColorFactor: THREE.BlendingDstFactor = THREE.SrcColorFactor;
export const OneMinusSrcColorFactor: THREE.BlendingDstFactor = THREE.OneMinusSrcColorFactor;
export const SrcAlphaFactor: THREE.BlendingDstFactor = THREE.SrcAlphaFactor;
export const OneMinusSrcAlphaFactor: THREE.BlendingDstFactor = THREE.OneMinusSrcAlphaFactor;
export const DstAlphaFactor: THREE.BlendingDstFactor = THREE.DstAlphaFactor;
export const OneMinusDstAlphaFactor: THREE.BlendingDstFactor = THREE.OneMinusDstAlphaFactor;
export const DstColorFactor: THREE.BlendingDstFactor = THREE.DstColorFactor;
export const OneMinusDstColorFactor: THREE.BlendingDstFactor = THREE.OneMinusDstColorFactor;
export const SrcAlphaSaturateFactor: THREE.BlendingSrcFactor = THREE.SrcAlphaSaturateFactor;
export const NeverDepth: THREE.DepthModes = THREE.NeverDepth;
export const AlwaysDepth: THREE.DepthModes = THREE.AlwaysDepth;
export const LessDepth: THREE.DepthModes = THREE.LessDepth;
export const LessEqualDepth: THREE.DepthModes = THREE.LessEqualDepth;
export const EqualDepth: THREE.DepthModes = THREE.EqualDepth;
export const GreaterEqualDepth: THREE.DepthModes = THREE.GreaterEqualDepth;
export const GreaterDepth: THREE.DepthModes = THREE.GreaterDepth;
export const NotEqualDepth: THREE.DepthModes = THREE.NotEqualDepth;
export const MultiplyOperation: THREE.Combine = THREE.MultiplyOperation;
export const MixOperation: THREE.Combine = THREE.MixOperation;
export const AddOperation: THREE.Combine = THREE.AddOperation;
export const NoToneMapping: THREE.ToneMapping = THREE.NoToneMapping;
export const LinearToneMapping: THREE.ToneMapping = THREE.LinearToneMapping;
export const ReinhardToneMapping: THREE.ToneMapping = THREE.ReinhardToneMapping;
export const CineonToneMapping: THREE.ToneMapping = THREE.CineonToneMapping;
export const ACESFilmicToneMapping: THREE.ToneMapping = THREE.ACESFilmicToneMapping;
export const UVMapping: THREE.Mapping = THREE.UVMapping;
export const CubeReflectionMapping: THREE.Mapping = THREE.CubeReflectionMapping;
export const CubeRefractionMapping: THREE.Mapping = THREE.CubeRefractionMapping;
export const EquirectangularReflectionMapping: THREE.Mapping = THREE.EquirectangularReflectionMapping;
export const EquirectangularRefractionMapping: THREE.Mapping = THREE.EquirectangularRefractionMapping;
export const CubeUVReflectionMapping: THREE.Mapping = THREE.CubeUVReflectionMapping;
export const CubeUVRefractionMapping: THREE.Mapping = THREE.CubeUVRefractionMapping;
export const RepeatWrapping: THREE.Wrapping = THREE.RepeatWrapping;
export const ClampToEdgeWrapping: THREE.Wrapping = THREE.ClampToEdgeWrapping;
export const MirroredRepeatWrapping: THREE.Wrapping = THREE.MirroredRepeatWrapping;
export const NearestFilter: THREE.TextureFilter = THREE.NearestFilter;
export const NearestMipmapNearestFilter: THREE.TextureFilter = THREE.NearestMipmapNearestFilter;
export const NearestMipMapNearestFilter: THREE.TextureFilter = THREE.NearestMipMapNearestFilter;
export const NearestMipmapLinearFilter: THREE.TextureFilter = THREE.NearestMipmapLinearFilter;
export const NearestMipMapLinearFilter: THREE.TextureFilter = THREE.NearestMipMapLinearFilter;
export const LinearFilter: THREE.TextureFilter = THREE.LinearFilter;
export const LinearMipmapNearestFilter: THREE.TextureFilter = THREE.LinearMipmapNearestFilter;
export const LinearMipMapNearestFilter: THREE.TextureFilter = THREE.LinearMipMapNearestFilter;
export const LinearMipmapLinearFilter: THREE.TextureFilter = THREE.LinearMipmapLinearFilter;
export const LinearMipMapLinearFilter: THREE.TextureFilter = THREE.LinearMipMapLinearFilter;
export const UnsignedByteType: THREE.TextureDataType = THREE.UnsignedByteType;
export const ByteType: THREE.TextureDataType = THREE.ByteType;
export const ShortType: THREE.TextureDataType = THREE.ShortType;
export const UnsignedShortType: THREE.TextureDataType = THREE.UnsignedShortType;
export const IntType: THREE.TextureDataType = THREE.IntType;
export const UnsignedIntType: THREE.TextureDataType = THREE.UnsignedIntType;
export const FloatType: THREE.TextureDataType = THREE.FloatType;
export const HalfFloatType: THREE.TextureDataType = THREE.HalfFloatType;
export const UnsignedShort4444Type: THREE.TextureDataType = THREE.UnsignedShort4444Type;
export const UnsignedShort5551Type: THREE.TextureDataType = THREE.UnsignedShort5551Type;
export const UnsignedShort565Type: THREE.TextureDataType = THREE.UnsignedShort565Type;
export const UnsignedInt248Type: THREE.TextureDataType = THREE.UnsignedInt248Type;
export const AlphaFormat: THREE.PixelFormat = THREE.AlphaFormat;
export const RGBFormat: THREE.PixelFormat = THREE.RGBFormat;
export const RGBAFormat: THREE.PixelFormat = THREE.RGBAFormat;
export const LuminanceFormat: THREE.PixelFormat = THREE.LuminanceFormat;
export const LuminanceAlphaFormat: THREE.PixelFormat = THREE.LuminanceAlphaFormat;
export const RGBEFormat: THREE.PixelFormat = THREE.RGBEFormat;
export const DepthFormat: THREE.PixelFormat = THREE.DepthFormat;
export const DepthStencilFormat: THREE.PixelFormat = THREE.DepthStencilFormat;
export const RedFormat: THREE.PixelFormat = THREE.RedFormat;
export const RedIntegerFormat: THREE.PixelFormat = THREE.RedIntegerFormat;
export const RGFormat: THREE.PixelFormat = THREE.RGFormat;
export const RGIntegerFormat: THREE.PixelFormat = THREE.RGIntegerFormat;
export const RGBIntegerFormat: THREE.PixelFormat = THREE.RGBIntegerFormat;
export const RGBAIntegerFormat: THREE.PixelFormat = THREE.RGBAIntegerFormat;
export const RGB_S3TC_DXT1_Format: THREE.CompressedPixelFormat = THREE.RGB_S3TC_DXT1_Format;
export const RGBA_S3TC_DXT1_Format: THREE.CompressedPixelFormat = THREE.RGBA_S3TC_DXT1_Format;
export const RGBA_S3TC_DXT3_Format: THREE.CompressedPixelFormat = THREE.RGBA_S3TC_DXT3_Format;
export const RGBA_S3TC_DXT5_Format: THREE.CompressedPixelFormat = THREE.RGBA_S3TC_DXT5_Format;
export const RGB_PVRTC_4BPPV1_Format: THREE.CompressedPixelFormat = THREE.RGB_PVRTC_4BPPV1_Format;
export const RGB_PVRTC_2BPPV1_Format: THREE.CompressedPixelFormat = THREE.RGB_PVRTC_2BPPV1_Format;
export const RGBA_PVRTC_4BPPV1_Format: THREE.CompressedPixelFormat = THREE.RGBA_PVRTC_4BPPV1_Format;
export const RGBA_PVRTC_2BPPV1_Format: THREE.CompressedPixelFormat = THREE.RGBA_PVRTC_2BPPV1_Format;
export const RGB_ETC1_Format: THREE.CompressedPixelFormat = THREE.RGB_ETC1_Format;
export const RGB_ETC2_Format: THREE.CompressedPixelFormat = THREE.RGB_ETC2_Format;
export const RGBA_ETC2_EAC_Format: THREE.CompressedPixelFormat = THREE.RGBA_ETC2_EAC_Format;
export const RGBA_ASTC_4x4_Format: THREE.CompressedPixelFormat = THREE.RGBA_ASTC_4x4_Format;
export const RGBA_ASTC_5x4_Format: THREE.CompressedPixelFormat = THREE.RGBA_ASTC_5x4_Format;
export const RGBA_ASTC_5x5_Format: THREE.CompressedPixelFormat = THREE.RGBA_ASTC_5x5_Format;
export const RGBA_ASTC_6x5_Format: THREE.CompressedPixelFormat = THREE.RGBA_ASTC_6x5_Format;
export const RGBA_ASTC_6x6_Format: THREE.CompressedPixelFormat = THREE.RGBA_ASTC_6x6_Format;
export const RGBA_ASTC_8x5_Format: THREE.CompressedPixelFormat = THREE.RGBA_ASTC_8x5_Format;
export const RGBA_ASTC_8x6_Format: THREE.CompressedPixelFormat = THREE.RGBA_ASTC_8x6_Format;
export const RGBA_ASTC_8x8_Format: THREE.CompressedPixelFormat = THREE.RGBA_ASTC_8x8_Format;
export const RGBA_ASTC_10x5_Format: THREE.CompressedPixelFormat = THREE.RGBA_ASTC_10x5_Format;
export const RGBA_ASTC_10x6_Format: THREE.CompressedPixelFormat = THREE.RGBA_ASTC_10x6_Format;
export const RGBA_ASTC_10x8_Format: THREE.CompressedPixelFormat = THREE.RGBA_ASTC_10x8_Format;
export const RGBA_ASTC_10x10_Format: THREE.CompressedPixelFormat = THREE.RGBA_ASTC_10x10_Format;
export const RGBA_ASTC_12x10_Format: THREE.CompressedPixelFormat = THREE.RGBA_ASTC_12x10_Format;
export const RGBA_ASTC_12x12_Format: THREE.CompressedPixelFormat = THREE.RGBA_ASTC_12x12_Format;
export const SRGB8_ALPHA8_ASTC_4x4_Format: THREE.CompressedPixelFormat = THREE.SRGB8_ALPHA8_ASTC_4x4_Format;
export const SRGB8_ALPHA8_ASTC_5x4_Format: THREE.CompressedPixelFormat = THREE.SRGB8_ALPHA8_ASTC_5x4_Format;
export const SRGB8_ALPHA8_ASTC_5x5_Format: THREE.CompressedPixelFormat = THREE.SRGB8_ALPHA8_ASTC_5x5_Format;
export const SRGB8_ALPHA8_ASTC_6x5_Format: THREE.CompressedPixelFormat = THREE.SRGB8_ALPHA8_ASTC_6x5_Format;
export const SRGB8_ALPHA8_ASTC_6x6_Format: THREE.CompressedPixelFormat = THREE.SRGB8_ALPHA8_ASTC_6x6_Format;
export const SRGB8_ALPHA8_ASTC_8x5_Format: THREE.CompressedPixelFormat = THREE.SRGB8_ALPHA8_ASTC_8x5_Format;
export const SRGB8_ALPHA8_ASTC_8x6_Format: THREE.CompressedPixelFormat = THREE.SRGB8_ALPHA8_ASTC_8x6_Format;
export const SRGB8_ALPHA8_ASTC_8x8_Format: THREE.CompressedPixelFormat = THREE.SRGB8_ALPHA8_ASTC_8x8_Format;
export const SRGB8_ALPHA8_ASTC_10x5_Format: THREE.CompressedPixelFormat = THREE.SRGB8_ALPHA8_ASTC_10x5_Format;
export const SRGB8_ALPHA8_ASTC_10x6_Format: THREE.CompressedPixelFormat = THREE.SRGB8_ALPHA8_ASTC_10x6_Format;
export const SRGB8_ALPHA8_ASTC_10x8_Format: THREE.CompressedPixelFormat = THREE.SRGB8_ALPHA8_ASTC_10x8_Format;
export const SRGB8_ALPHA8_ASTC_10x10_Format: THREE.CompressedPixelFormat = THREE.SRGB8_ALPHA8_ASTC_10x10_Format;
export const SRGB8_ALPHA8_ASTC_12x10_Format: THREE.CompressedPixelFormat = THREE.SRGB8_ALPHA8_ASTC_12x10_Format;
export const SRGB8_ALPHA8_ASTC_12x12_Format: THREE.CompressedPixelFormat = THREE.SRGB8_ALPHA8_ASTC_12x12_Format;
export const RGBA_BPTC_Format: THREE.CompressedPixelFormat = THREE.RGBA_BPTC_Format;
export const LoopOnce: THREE.AnimationActionLoopStyles = THREE.LoopOnce;
export const LoopRepeat: THREE.AnimationActionLoopStyles = THREE.LoopRepeat;
export const LoopPingPong: THREE.AnimationActionLoopStyles = THREE.LoopPingPong;
export const InterpolateDiscrete: THREE.InterpolationModes = THREE.InterpolateDiscrete;
export const InterpolateLinear: THREE.InterpolationModes = THREE.InterpolateLinear;
export const InterpolateSmooth: THREE.InterpolationModes = THREE.InterpolateSmooth;
export const ZeroCurvatureEnding: THREE.InterpolationEndingModes = THREE.ZeroCurvatureEnding;
export const ZeroSlopeEnding: THREE.InterpolationEndingModes = THREE.ZeroSlopeEnding;
export const WrapAroundEnding: THREE.InterpolationEndingModes = THREE.WrapAroundEnding;
export const NormalAnimationBlendMode: THREE.AnimationBlendMode = THREE.NormalAnimationBlendMode;
export const AdditiveAnimationBlendMode: THREE.AnimationBlendMode = THREE.AdditiveAnimationBlendMode;
export const TrianglesDrawMode: THREE.TrianglesDrawModes = THREE.TrianglesDrawMode;
export const TriangleStripDrawMode: THREE.TrianglesDrawModes = THREE.TriangleStripDrawMode;
export const TriangleFanDrawMode: THREE.TrianglesDrawModes = THREE.TriangleFanDrawMode;
export const LinearEncoding: THREE.TextureEncoding = THREE.LinearEncoding;
export const sRGBEncoding: THREE.TextureEncoding = THREE.sRGBEncoding;
export const GammaEncoding: THREE.TextureEncoding = THREE.GammaEncoding;
export const RGBEEncoding: THREE.TextureEncoding = THREE.RGBEEncoding;
// export const LogLuvEncoding: THREE.TextureEncoding = THREE.LogLuvEncoding;
export const RGBM7Encoding: THREE.TextureEncoding = THREE.RGBM7Encoding;
export const RGBM16Encoding: THREE.TextureEncoding = THREE.RGBM16Encoding;
export const RGBDEncoding: THREE.TextureEncoding = THREE.RGBDEncoding;
export const BasicDepthPacking: THREE.DepthPackingStrategies = THREE.BasicDepthPacking;
export const RGBADepthPacking: THREE.DepthPackingStrategies = THREE.RGBADepthPacking;
export const TangentSpaceNormalMap: THREE.NormalMapTypes = THREE.TangentSpaceNormalMap;
export const ObjectSpaceNormalMap: THREE.NormalMapTypes = THREE.ObjectSpaceNormalMap;
export const ZeroStencilOp: THREE.StencilOp = THREE.ZeroStencilOp;
export const KeepStencilOp: THREE.StencilOp = THREE.KeepStencilOp;
export const ReplaceStencilOp: THREE.StencilOp = THREE.ReplaceStencilOp;
export const IncrementStencilOp: THREE.StencilOp = THREE.IncrementStencilOp;
export const DecrementStencilOp: THREE.StencilOp = THREE.DecrementStencilOp;
export const IncrementWrapStencilOp: THREE.StencilOp = THREE.IncrementWrapStencilOp;
export const DecrementWrapStencilOp: THREE.StencilOp = THREE.DecrementWrapStencilOp;
export const InvertStencilOp: THREE.StencilOp = THREE.InvertStencilOp;
export const NeverStencilFunc: THREE.StencilFunc = THREE.NeverStencilFunc;
export const LessStencilFunc: THREE.StencilFunc = THREE.LessStencilFunc;
export const EqualStencilFunc: THREE.StencilFunc = THREE.EqualStencilFunc;
export const LessEqualStencilFunc: THREE.StencilFunc = THREE.LessEqualStencilFunc;
export const GreaterStencilFunc: THREE.StencilFunc = THREE.GreaterStencilFunc;
export const NotEqualStencilFunc: THREE.StencilFunc = THREE.NotEqualStencilFunc;
export const GreaterEqualStencilFunc: THREE.StencilFunc = THREE.GreaterEqualStencilFunc;
export const AlwaysStencilFunc: THREE.StencilFunc = THREE.AlwaysStencilFunc;
export const StaticDrawUsage: THREE.Usage = THREE.StaticDrawUsage;
export const DynamicDrawUsage: THREE.Usage = THREE.DynamicDrawUsage;
export const StreamDrawUsage: THREE.Usage = THREE.StreamDrawUsage;
export const StaticReadUsage: THREE.Usage = THREE.StaticReadUsage;
export const DynamicReadUsage: THREE.Usage = THREE.DynamicReadUsage;
export const StreamReadUsage: THREE.Usage = THREE.StreamReadUsage;
export const StaticCopyUsage: THREE.Usage = THREE.StaticCopyUsage;
export const DynamicCopyUsage: THREE.Usage = THREE.DynamicCopyUsage;
export const StreamCopyUsage: THREE.Usage = THREE.StreamCopyUsage;
export const GLSL1: THREE.GLSLVersion = THREE.GLSL1;
export const GLSL3: THREE.GLSLVersion = THREE.GLSL3;
