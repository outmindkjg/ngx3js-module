...
var Ammo = (function () {
	...
	return function (Ammo) {
		...
		var $a = (b._emscripten_bind_btCollisionWorld_getDispatcher_0 =
			...
			xb = (b._emscripten_bind_btCollisionObject_setAnisotropicFriction_2 =
				function () {
					return (xb =
			...
			Hb = (b._emscripten_bind_btCollisionObject_isStaticOrKinematicObject_0 =
				function () {
					return (Hb =
			...
			Le = (b._emscripten_bind_btDiscreteDynamicsWorld_removeConstraint_1 =
				function () {
					return (Le =
			...
			Xe = (b._emscripten_bind_btDiscreteDynamicsWorld_addCollisionObject_2 =
				function () {
					return (Xe =
						b._emscripten_bind_btDiscreteDynamicsWorld_addCollisionObject_2 =
							b.asm.$c).apply(null, arguments);
				}),
			Ye = (b._emscripten_bind_btDiscreteDynamicsWorld_addCollisionObject_3 =
				function () {
					return (Ye =
			...
			df = (b._emscripten_bind_btDiscreteDynamicsWorld_updateSingleAabb_1 =
				function () {
					return (df =
			...
			Bf = (b._emscripten_bind_btGeneric6DofConstraint_setLinearLowerLimit_1 =
				function () {
					return (Bf =
						b._emscripten_bind_btGeneric6DofConstraint_setLinearLowerLimit_1 =
							b.asm.Dd).apply(null, arguments);
				}),
			Cf = (b._emscripten_bind_btGeneric6DofConstraint_setLinearUpperLimit_1 =
				function () {
					return (Cf =
						b._emscripten_bind_btGeneric6DofConstraint_setLinearUpperLimit_1 =
							b.asm.Ed).apply(null, arguments);
				}),
			Df = (b._emscripten_bind_btGeneric6DofConstraint_setAngularLowerLimit_1 =
				function () {
					return (Df =
						b._emscripten_bind_btGeneric6DofConstraint_setAngularLowerLimit_1 =
							b.asm.Fd).apply(null, arguments);
				}),
			Ef = (b._emscripten_bind_btGeneric6DofConstraint_setAngularUpperLimit_1 =
				function () {
					return (Ef =
			...
			Xf = (b._emscripten_bind_ConvexResultCallback_set_m_closestHitFraction_1 =
				function () {
					return (Xf =
			...
			eg = (b._emscripten_bind_RayResultCallback_get_m_collisionFilterMask_0 =
				function () {
					return (eg =
						b._emscripten_bind_RayResultCallback_get_m_collisionFilterMask_0 =
							b.asm.fe).apply(null, arguments);
				}),
			fg = (b._emscripten_bind_RayResultCallback_set_m_collisionFilterMask_1 =
				function () {
					return (fg =
			...
			hh = (b._emscripten_bind_btWheelInfoConstructionInfo_get_m_wheelRadius_0 =
				function () {
					return (hh =
			...
			yh = (b._emscripten_bind_btConvexTriangleMeshShape_setLocalScaling_1 =
				function () {
					return (yh =
			...
			Mh = (b._emscripten_bind_btRigidBodyConstructionInfo_get_m_friction_0 =
				function () {
					return (Mh =
			...
			Qh = (b._emscripten_bind_btRigidBodyConstructionInfo_get_m_restitution_0 =
				function () {
					return (Qh =
						b._emscripten_bind_btRigidBodyConstructionInfo_get_m_restitution_0 =
							b.asm.Rf).apply(null, arguments);
				}),
			Rh = (b._emscripten_bind_btRigidBodyConstructionInfo_set_m_restitution_1 =
				function () {
					return (Rh =
			...
			Xi = (b._emscripten_bind_AllHitsRayResultCallback_get_m_rayFromWorld_0 =
				function () {
					return (Xi =
			...
			Zi = (b._emscripten_bind_AllHitsRayResultCallback_get_m_rayToWorld_0 =
				function () {
					return (Zi =
						b._emscripten_bind_AllHitsRayResultCallback_get_m_rayToWorld_0 =
							b.asm.Zg).apply(null, arguments);
				}),
			$i = (b._emscripten_bind_AllHitsRayResultCallback_set_m_rayToWorld_1 =
				function () {
					return ($i =
			...
			bj = (b._emscripten_bind_AllHitsRayResultCallback_set_m_hitNormalWorld_1 =
				function () {
					return (bj =
			...
			fj = (b._emscripten_bind_AllHitsRayResultCallback_set_m_hitFractions_1 =
				function () {
					return (fj =
			...
			xk = (b._emscripten_bind_btRigidBody_setContactProcessingThreshold_1 =
				function () {
					return (xk =
			...
			gl = (b._emscripten_bind_btHeightfieldTerrainShape_setLocalScaling_1 =
				function () {
					return (gl =
			...
			ml = (b._emscripten_bind_btCollisionDispatcher_btCollisionDispatcher_1 =
				function () {
					return (ml =
			...
			Dl = (b._emscripten_bind_btSoftBodyWorldInfo_get_m_maxDisplacement_0 =
				function () {
					return (Dl =
			...
			Pl = (b._emscripten_bind_btConeTwistConstraint_btConeTwistConstraint_4 =
				function () {
					return (Pl =
			...
			sm = (b._emscripten_bind_btHingeConstraint_setBreakingImpulseThreshold_1 =
				function () {
					return (sm =
			...
			gn = (b._emscripten_bind_btVehicleTuning_get_m_suspensionStiffness_0 =
				function () {
					return (gn =
						b._emscripten_bind_btVehicleTuning_get_m_suspensionStiffness_0 =
							b.asm.$k).apply(null, arguments);
				}),
			hn = (b._emscripten_bind_btVehicleTuning_set_m_suspensionStiffness_1 =
				function () {
					return (hn =
			...
			kn = (b._emscripten_bind_btVehicleTuning_set_m_suspensionCompression_1 =
				function () {
					return (kn =
			...
			nn = (b._emscripten_bind_btVehicleTuning_get_m_maxSuspensionTravelCm_0 =
				function () {
					return (nn =
			...
			rn = (b._emscripten_bind_btVehicleTuning_get_m_maxSuspensionForce_0 =
				function () {
					return (rn =
						b._emscripten_bind_btVehicleTuning_get_m_maxSuspensionForce_0 =
							b.asm.jl).apply(null, arguments);
				}),
			sn = (b._emscripten_bind_btVehicleTuning_set_m_maxSuspensionForce_1 =
				function () {
					return (sn =
						b._emscripten_bind_btVehicleTuning_set_m_maxSuspensionForce_1 =
							b.asm.kl).apply(null, arguments);
				}),
			tn = (b._emscripten_bind_btCollisionObjectWrapper_getWorldTransform_0 =
				function () {
					return (tn =
			...
			vn = (b._emscripten_bind_btCollisionObjectWrapper_getCollisionShape_0 =
				function () {
					return (vn =
			...
			Bn = (b._emscripten_bind_btDefaultMotionState_btDefaultMotionState_0 =
				function () {
					return (Bn =
						b._emscripten_bind_btDefaultMotionState_btDefaultMotionState_0 =
							b.asm.tl).apply(null, arguments);
				}),
			Cn = (b._emscripten_bind_btDefaultMotionState_btDefaultMotionState_1 =
				function () {
					return (Cn =
			...
			Hn = (b._emscripten_bind_btDefaultMotionState_set_m_graphicsWorldTrans_1 =
				function () {
					return (Hn =
			...
			ao = (b._emscripten_bind_btWheelInfo_set_m_wheelsDampingRelaxation_1 =
				function () {
					return (ao =
			...
			oo = (b._emscripten_bind_btWheelInfo_get_m_chassisConnectionPointCS_0 =
				function () {
					return (oo =
			...
			Fo = (b._emscripten_bind_btWheelInfo_set_m_suspensionRelativeVelocity_1 =
				function () {
					return (Fo =
			...
			wp = (b._emscripten_bind_btVehicleRaycasterResult_set_m_distFraction_1 =
				function () {
					return (wp =
			...
			Tp = (b._emscripten_bind_btRaycastVehicle_updateWheelTransformsWS_1 =
				function () {
					return (Tp =
						b._emscripten_bind_btRaycastVehicle_updateWheelTransformsWS_1 =
							b.asm.Jn).apply(null, arguments);
				}),
			Up = (b._emscripten_bind_btRaycastVehicle_updateWheelTransformsWS_2 =
				function () {
					return (Up =
			...
			Lt = (b._emscripten_bind_btKinematicCharacterController_setUpAxis_1 =
				function () {
					return (Lt =
			...
			Rt = (b._emscripten_bind_btKinematicCharacterController_setFallSpeed_1 =
				function () {
					return (Rt =
			...
			Xt = (b._emscripten_bind_btKinematicCharacterController_getGravity_0 =
				function () {
					return (Xt =
						b._emscripten_bind_btKinematicCharacterController_getGravity_0 =
							b.asm.Hr).apply(null, arguments);
				}),
			Yt = (b._emscripten_bind_btKinematicCharacterController_setMaxSlope_1 =
				function () {
					return (Yt =
			...
			eu = (b._emscripten_bind_btKinematicCharacterController___destroy___0 =
				function () {
					return (eu =
			...
			ou = (b._emscripten_bind_btStaticPlaneShape_calculateLocalInertia_2 =
				function () {
					return (ou =
			...
			Bu = (b._emscripten_bind_btSoftRigidDynamicsWorld_getSoftBodyArray_0 =
				function () {
					return (Bu =
			...
			Fu = (b._emscripten_bind_btSoftRigidDynamicsWorld_getDispatchInfo_0 =
				function () {
					return (Fu =
						b._emscripten_bind_btSoftRigidDynamicsWorld_getDispatchInfo_0 =
							b.asm.os).apply(null, arguments);
				}),
			Gu = (b._emscripten_bind_btSoftRigidDynamicsWorld_addCollisionObject_1 =
				function () {
					return (Gu =
						b._emscripten_bind_btSoftRigidDynamicsWorld_addCollisionObject_1 =
							b.asm.ps).apply(null, arguments);
				}),
			Hu = (b._emscripten_bind_btSoftRigidDynamicsWorld_addCollisionObject_2 =
				function () {
					return (Hu =
			...
			Nu = (b._emscripten_bind_btSoftRigidDynamicsWorld_updateSingleAabb_1 =
				function () {
					return (Nu =
			...
			Ru = (b._emscripten_bind_btSoftRigidDynamicsWorld_debugDrawObject_3 =
				function () {
					return (Ru =
			...
			Zu = (b._emscripten_bind_btSoftRigidDynamicsWorld_removeConstraint_1 =
				function () {
					return (Zu =
			...
			ov = (b._emscripten_bind_btFixedConstraint_getBreakingImpulseThreshold_0 =
				function () {
					return (ov =
						b._emscripten_bind_btFixedConstraint_getBreakingImpulseThreshold_0 =
							b.asm.Ys).apply(null, arguments);
				}),
			pv = (b._emscripten_bind_btFixedConstraint_setBreakingImpulseThreshold_1 =
				function () {
					return (pv =
			...
			Kv = (b._emscripten_bind_ClosestRayResultCallback_set_m_rayToWorld_1 =
				function () {
					return (Kv =
			...
			Nv = (b._emscripten_bind_ClosestRayResultCallback_get_m_hitPointWorld_0 =
				function () {
					return (Nv =
			...
			cw = (b._emscripten_bind_ConcreteContactResultCallback___destroy___0 =
				function () {
					return (cw =
						b._emscripten_bind_ConcreteContactResultCallback___destroy___0 =
							b.asm.Lt).apply(null, arguments);
				}),
			dw = (b._emscripten_bind_btBvhTriangleMeshShape_btBvhTriangleMeshShape_2 =
				function () {
					return (dw =
						b._emscripten_bind_btBvhTriangleMeshShape_btBvhTriangleMeshShape_2 =
							b.asm.Mt).apply(null, arguments);
				}),
			ew = (b._emscripten_bind_btBvhTriangleMeshShape_btBvhTriangleMeshShape_3 =
				function () {
					return (ew =
			...
			hw = (b._emscripten_bind_btBvhTriangleMeshShape_calculateLocalInertia_2 =
				function () {
					return (hw =
			...
			Aw = (b._emscripten_bind_btPairCachingGhostObject_getCollisionShape_0 =
				function () {
					return (Aw =
			...
			Dw = (b._emscripten_bind_btPairCachingGhostObject_forceActivationState_1 =
				function () {
					return (Dw =
			...
			Hw = (b._emscripten_bind_btPairCachingGhostObject_isKinematicObject_0 =
				function () {
					return (Hw =
			...
			Mw = (b._emscripten_bind_btPairCachingGhostObject_getRollingFriction_0 =
				function () {
					return (Mw =
			...
			cx = (b._emscripten_bind_btPairCachingGhostObject_getOverlappingObject_1 =
				function () {
					return (cx =
			...
			sx = (b._emscripten_bind_btManifoldPoint_get_m_userPersistentData_0 =
				function () {
					return (sx =
						b._emscripten_bind_btManifoldPoint_get_m_userPersistentData_0 =
							b.asm._u).apply(null, arguments);
				}),
			tx = (b._emscripten_bind_btManifoldPoint_set_m_userPersistentData_1 =
				function () {
					return (tx =
			...
			Ux = (b._emscripten_bind_btBroadphaseProxy_set_m_collisionFilterMask_1 =
				function () {
					return (Ux =
			...
			xz = (b._emscripten_bind_btGeneric6DofSpringConstraint_enableSpring_2 =
				function () {
					return (xz =
			...
			zz = (b._emscripten_bind_btGeneric6DofSpringConstraint_setDamping_2 =
				function () {
					return (zz =
			...
			Hz = (b._emscripten_bind_btGeneric6DofSpringConstraint_getFrameOffsetA_0 =
				function () {
					return (Hz =
						b._emscripten_bind_btGeneric6DofSpringConstraint_getFrameOffsetA_0 =
							b.asm.lx).apply(null, arguments);
				}),
			Iz = (b._emscripten_bind_btGeneric6DofSpringConstraint_enableFeedback_1 =
				function () {
					return (Iz =
			...
			fA = (b._emscripten_bind_LocalConvexResult_get_m_hitCollisionObject_0 =
				function () {
					return (fA =
		...
		C.prototype.get_m_additionalAngularDampingThresholdSqr = C.prototype.vz =
			function () {
				return bi(this.hy);
			};
		C.prototype.set_m_additionalAngularDampingThresholdSqr = C.prototype.bC =
			function (a) {
				var c = this.hy;
				a && 'object' === typeof a && (a = a.hy);
				ci(c, a);
