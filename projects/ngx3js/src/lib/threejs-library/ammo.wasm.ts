...
export function AmmoInit<T>(target?: T): Promise<T & AmmoType> {
    ...
    if (windowAlias.Ammo !== undefined) {
        return windowAlias.Ammo(target) as any;
    }
    return new Promise(() => {});
}
...
export interface LocalConvexResult {
    new(hitCollisionObject: btCollisionObject, localShapeInfo: LocalShapeInfo, hitNormalLocal: btVector3, hitPointLocal: btVector3, hitFraction: number): this;
...
export interface btMultiSphereShape extends btCollisionShape {
    new(positions: btVector3, radii: ReadonlyArray<number>, numPoints: number): this;
}
...
export interface btBvhTriangleMeshShape extends btTriangleMeshShape {
    new(meshInterface: btStridingMeshInterface, useQuantizedAabbCompression: boolean, buildBvh?: boolean): this;
}
export interface btHeightfieldTerrainShape extends btConcaveShape {
    new(heightStickWidth: number, heightStickLength: number, heightfieldData: unknown, heightScale: number, minHeight: number, maxHeight: number, upAxis: number, hdt: PHY_ScalarType, flipQuadEdges: boolean): this;
    setMargin(margin: number): void;
    getMargin(): number;
}
...
export interface btAxisSweep3 {
    new(worldAabbMin: btVector3, worldAabbMax: btVector3, maxHandles?: number, pairCache?: btOverlappingPairCache, disableRaycastAccelerator?: boolean): this;
}
...
export interface btRigidBodyConstructionInfo {
    new(mass: number, motionState: btMotionState, collisionShape: btCollisionShape, localInertia?: btVector3): this;
...
export type btConstraintParams = "BT_CONSTRAINT_ERP" | "BT_CONSTRAINT_STOP_ERP" | "BT_CONSTRAINT_CFM" | "BT_CONSTRAINT_STOP_CFM";
export interface btPoint2PointConstraint extends btTypedConstraint {
    new(rbA: btRigidBody, rbB: btRigidBody, pivotInA: btVector3, pivotInB: btVector3): this;
...
export interface btGeneric6DofConstraint extends btTypedConstraint {
    new(rbA: btRigidBody, rbB: btRigidBody, frameInA: btTransform, frameInB: btTransform, useLinearFrameReferenceFrameA: boolean): this;
    new(rbB: btRigidBody, frameInB: btTransform, useLinearFrameReferenceFrameB: boolean): this;
...
export interface btConeTwistConstraint extends btTypedConstraint {
    new(rbA: btRigidBody, rbB: btRigidBody, rbAFrame: btTransform, rbBFrame: btTransform): this;
...
export interface btHingeConstraint extends btTypedConstraint {
    new(rbA: btRigidBody, rbB: btRigidBody, pivotInA: btVector3, pivotInB: btVector3, axisInA: btVector3, axisInB: btVector3, useReferenceFrameA?: boolean): this;
    new(rbA: btRigidBody, rbB: btRigidBody, rbAFrame: btTransform, rbBFrame: btTransform, useReferenceFrameA?: boolean): this;
    new(rbA: btRigidBody, rbAFrame: btTransform, useReferenceFrameA?: boolean): this;
...
export interface btSliderConstraint extends btTypedConstraint {
    new(rbA: btRigidBody, rbB: btRigidBody, frameInA: btTransform, frameInB: btTransform, useLinearReferenceFrameA: boolean): this;
    new(rbB: btRigidBody, frameInB: btTransform, useLinearReferenceFrameA: boolean): this;
...
export interface btFixedConstraint extends btTypedConstraint {
    new(rbA: btRigidBody, rbB: btRigidBody, frameInA: btTransform, frameInB: btTransform): this;
}
...
export interface btDiscreteDynamicsWorld extends btDynamicsWorld {
    new(dispatcher: btDispatcher, pairCache: btBroadphaseInterface, constraintSolver: btConstraintSolver, collisionConfiguration: btCollisionConfiguration): this;
...
export interface btKinematicCharacterController extends btActionInterface {
    new(ghostObject: btPairCachingGhostObject, convexShape: btConvexShape, stepHeight: number, upAxis?: number): this;
...
export interface btRaycastVehicle extends btActionInterface {
    new(tuning: btVehicleTuning, chassis: btRigidBody, raycaster: btVehicleRaycaster): this;
...
export interface btSoftBody extends btCollisionObject {
    new(worldInfo: btSoftBodyWorldInfo, node_count: number, x: btVector3, m: ReadonlyArray<number>): this;
    get_m_cfg(): Config;
...
export interface btSoftBodyRigidBodyCollisionConfiguration extends btDefaultCollisionConfiguration {
    new(info?: btDefaultCollisionConstructionInfo): this;
}
...
export interface btSoftRigidDynamicsWorld extends btDiscreteDynamicsWorld {
    new(dispatcher: btDispatcher, pairCache: btBroadphaseInterface, constraintSolver: btConstraintSolver, collisionConfiguration: btCollisionConfiguration, softBodySolver: btSoftBodySolver): this;
