...
export class MeshComponent extends AbstractObject3dComponent implements OnInit {
  ...
  private getTextureSize(width?: number, height?: number): THREE.Vector2 {
    ...
    return ThreeUtil.getVector2Safe(ThreeUtil.getTypeSafe(this.textureWidth, width, 1024), ThreeUtil.getTypeSafe(this.textureHeight, height, 1024), null, null, true).multiplyScalar(window.devicePixelRatio);
  }
    ...
    if (this.mesh === null || this._needUpdate) {
      ...
      switch (this.type.toLowerCase()) {
        ...
        case 'tubepainter':
          ...
          break;
        case 'text':
          basemesh = createText(ThreeUtil.getTypeSafe(this.text, 'test'), ThreeUtil.getTypeSafe(this.size, 1));
          break;
        case 'line2':
