...
@Component({
  ...
  providers: [{ provide: AbstractObject3dComponent, useExisting: forwardRef(() => ChartPieComponent) }],
})
export class ChartPieComponent extends AbstractChartComponent implements OnInit {
  /**
