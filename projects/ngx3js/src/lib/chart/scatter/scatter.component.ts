...
@Component({
  ...
  providers: [{ provide: AbstractObject3dComponent, useExisting: forwardRef(() => ChartScatterComponent) }],
})
export class ChartScatterComponent extends AbstractChartComponent implements OnInit {
  /**
