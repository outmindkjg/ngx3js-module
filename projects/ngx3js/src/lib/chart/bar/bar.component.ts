...
, providers: [{ provide: AbstractObject3dComponent, useExisting: forwardRef(() => ChartBarComponent) }]
})
export class ChartBarComponent extends AbstractChartComponent implements OnInit {
