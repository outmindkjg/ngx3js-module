 ...
 *
 * See the [ngx3js docs](https://outmindkjg.github.io/ngx3js-doc/#/docs/ngxapi/en/NgxChartDoughnutComponent) page for details.
 *
 */
@Component({
	...
	providers: [
		{
			...
			useExisting: forwardRef(() => NgxChartDoughnutComponent),
		},
	],
})
export class NgxChartDoughnutComponent
