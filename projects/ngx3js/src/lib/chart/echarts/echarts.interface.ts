...
export interface XAxis extends CartesianAxis {
	/**
...
export interface YAxis extends CartesianAxis {
	/**
...
export interface EChartsConvertFinder {
...
export type EChartsMediaOption = {
	query: {
...
export interface CartesianAxis {
	 ...
	 */
	minorSplitLine?: MinorSplitLine | undefined;
	 ...
	 */
	data?: (string | number | DataObject)[] | undefined;
 ...
 * @todo describe
 */
export interface Label extends Omit<any, 'color'> {
	color?: string | ((val: string) => any) | undefined;
	show?: boolean | undefined;
	interval?: number | Function | undefined;
	inside?: boolean | undefined;
 ...
 * @todo describe
 */
export interface MinorSplitLine {
	show?: boolean | undefined;
	lineStyle?: any;
}
