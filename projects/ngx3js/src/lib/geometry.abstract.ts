...
export abstract class AbstractGeometryComponent extends AbstractSubscribeComponent implements OnInit, OnChanges, AfterContentInit, OnDestroy {
   ...
   * Input  of abstract geometry component
   */
  @Input() public morphAttributes: { [key: string]: AttrBufferAttribute[] } = null;
   ...
   * Input  of abstract geometry component
   */
  @Input() public vertexBuffer: Float32Array | THREE.InterleavedBuffer | number[] = null;
   ...
   * Input  of abstract geometry component
   */
  @Input() public onInit: (geometry: THREE.BufferGeometry) => void | THREE.BufferGeometry = null;
