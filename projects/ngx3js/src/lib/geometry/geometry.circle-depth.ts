 ...
 *
 * See the [ngx3js docs](https://outmindkjg.github.io/ngx3js-doc/#/docs/ngxapi/en/CircleDepthGeometry) page for details.
...
export class CircleDepthGeometry extends THREE.BufferGeometry {
	...
	constructor(
		...
		const frontGeometry = new THREE.CircleBufferGeometry(
			radius,
			segments,
			thetaStart,
			thetaLength
