...
export class PlanePerlinGeometry {
  ...
  public getMinecraft(planeWidth: number, planeHeight: number, planeDepth: number): THREE.BufferGeometry {
    ...
    const geometry: {
      ...
      px: this.getGeometry(planeGeometry, [1, 3], { x: 0, y: Math.PI / 2, z: 0 }, { x: 50, y: 0, z: 0 }),
      nx: this.getGeometry(planeGeometry, [1, 3], { x: 0, y: -Math.PI / 2, z: 0 }, { x: -50, y: 0, z: 0 }),
      py: this.getGeometry(planeGeometry, [5, 7], { x: -Math.PI / 2, y: 0, z: 0 }, { x: 0, y: 50, z: 0 }),
      pz: this.getGeometry(planeGeometry, [1, 3], { x: 0, y: 0, z: 0 }, { x: 0, y: 0, z: 50 }),
      nz: this.getGeometry(planeGeometry, [1, 3], { x: 0, y: Math.PI, z: 0 }, { x: 0, y: 0, z: -50 }),
    };
    ...
    for (let z = 0; z < worldDepth; z++) {
      for (let x = 0; x < worldWidth; x++) {
        ...
        matrix.makeTranslation(x * planeWidth - worldHalfWidth * planeWidth, h * planeHeight, z * planeDepth - worldHalfDepth * planeDepth);
  ...
  public getMinecraftAo(planeWidth: number, planeHeight: number, planeDepth: number, light: THREE.Color, shadow: THREE.Color): THREE.BufferGeometry {
    ...
    const geometry: {
      ...
      px: this.getGeometry(planeGeometry, [1, 5, 11], { x: 0, y: Math.PI / 2, z: 0 }, { x: 50, y: 0, z: 0 }, [light, shadow, light, shadow, shadow, light]),
      nx: this.getGeometry(planeGeometry, [1, 5, 11], { x: 0, y: -Math.PI / 2, z: 0 }, { x: -50, y: 0, z: 0 }, [light, shadow, light, shadow, shadow, light]),
      py: this.getGeometry(planeGeometry, [3, 7, 9], { x: -Math.PI / 2, y: 0, z: 0 }, { x: 0, y: 50, z: 0 }, [light, light, light, light, light, light]),
      py2: this.getGeometry(planeGeometry, [3, 7, 9], { x: -Math.PI / 2, y: Math.PI / 2, z: 0 }, { x: 0, y: 50, z: 0 }, [light, light, light, light, light, light]),
      pz: this.getGeometry(planeGeometry, [1, 5, 11], { x: 0, y: 0, z: 0 }, { x: 0, y: 0, z: 50 }, [light, shadow, light, shadow, shadow, light]),
      nz: this.getGeometry(planeGeometry, [1, 5, 11], { x: 0, y: Math.PI, z: 0 }, { x: 0, y: 0, z: -50 }, [light, shadow, light, shadow, shadow, light]),
    };
    const geometries: THREE.BufferGeometry[] = [];
    const worldDepth = this.worldDepth;
    const worldWidth = this.worldWidth;
