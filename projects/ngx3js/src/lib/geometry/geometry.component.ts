      ...
      if (geometry === null) {
        switch (this.type.toLowerCase()) {
          ...
          case 'teapot':
            ...
            const teapot = new TeapotGeometryAlias(ThreeUtil.getTypeSafe(this.size), ThreeUtil.getTypeSafe(this.segments, this.radiusSegments), ThreeUtil.getTypeSafe(this.bottom), ThreeUtil.getTypeSafe(this.lid), ThreeUtil.getTypeSafe(this.body), ThreeUtil.getTypeSafe(this.fitLid), ThreeUtil.getTypeSafe(this.blinn));
            geometry = teapot;
            break;
          ...
          case 'gridbuffer':
          case 'grid':
            const gridGeometry = new GridGeometry(ThreeUtil.getTypeSafe(this.width, this.height, 1), ThreeUtil.getTypeSafe(this.height, this.width, 1), ThreeUtil.getTypeSafe(this.depth, 0), ThreeUtil.getTypeSafe(this.widthSegments, this.segments, 1), ThreeUtil.getTypeSafe(this.heightSegments, this.segments, 1), ThreeUtil.getColorSafe(this.color1, 0x444444), ThreeUtil.getColorSafe(this.color2, 0x888888));
          ...
          case 'capsulebuffer':
          case 'capsule':
            const capsuleGeometry = new CapsuleGeometry(ThreeUtil.getTypeSafe(this.radius, 1), ThreeUtil.getTypeSafe(this.radiusSegments, this.radialSegments, 8), ThreeUtil.getTypeSafe(this.height, this.width, 10), ThreeUtil.getTypeSafe(this.heightSegments, this.segments, 3), ThreeUtil.getAngleSafe(this.phiStart, 0), ThreeUtil.getAngleSafe(this.phiLength, 360));
          ...
          case 'boxline':
            geometry = new BoxLineGeometry(ThreeUtil.getTypeSafe(this.width, this.height, 1), ThreeUtil.getTypeSafe(this.height, this.width, 1), ThreeUtil.getTypeSafe(this.depth, this.width, 1), ThreeUtil.getTypeSafe(this.widthSegments, this.segments, 1), ThreeUtil.getTypeSafe(this.heightSegments, this.segments, 1), ThreeUtil.getTypeSafe(this.depthSegments, this.segments, 1));
            break;
          ...
          case 'boxbuffer':
          case 'box':
            geometry = new THREE.BoxBufferGeometry(ThreeUtil.getTypeSafe(this.width, this.height, 1), ThreeUtil.getTypeSafe(this.height, this.width, 1), ThreeUtil.getTypeSafe(this.depth, this.width, 1), ThreeUtil.getTypeSafe(this.widthSegments, this.segments, 1), ThreeUtil.getTypeSafe(this.heightSegments, this.segments, 1), ThreeUtil.getTypeSafe(this.depthSegments, this.segments, 1));
            break;
          ...
          case 'conebuffer':
          case 'cone':
            geometry = new THREE.ConeBufferGeometry(ThreeUtil.getTypeSafe(this.radius, 1), ThreeUtil.getTypeSafe(this.height, this.width, 1), ThreeUtil.getTypeSafe(this.radialSegments, this.radiusSegments, 8), ThreeUtil.getTypeSafe(this.heightSegments, this.segments, 1), ThreeUtil.getTypeSafe(this.openEnded, false), ThreeUtil.getAngleSafe(this.thetaStart, 0), ThreeUtil.getAngleSafe(this.thetaLength, 360));
            break;
          case 'cylinderbuffergeometry':
          case 'cylindergeometry':
          case 'cylinderbuffer':
          case 'cylinder':
            geometry = new THREE.CylinderBufferGeometry(ThreeUtil.getTypeSafe(this.radiusTop, this.radiusBottom, 1), ThreeUtil.getTypeSafe(this.radiusBottom, this.radiusTop, 1), ThreeUtil.getTypeSafe(this.height, this.width, 1), ThreeUtil.getTypeSafe(this.radialSegments, this.radiusSegments, 8), ThreeUtil.getTypeSafe(this.heightSegments, this.segments, 1), ThreeUtil.getTypeSafe(this.openEnded, false), ThreeUtil.getAngleSafe(this.thetaStart, 0), ThreeUtil.getAngleSafe(this.thetaLength, 360));
            break;
          ...
          case 'plane':
            if (ThreeUtil.isNotNull(this.depth) && this.depth > 0) {
              geometry = new PlaneDepthGeometry(ThreeUtil.getTypeSafe(this.width, this.height, 1), ThreeUtil.getTypeSafe(this.height, this.width, 1), ThreeUtil.getTypeSafe(this.depth, this.width, 1), ThreeUtil.getTypeSafe(this.widthSegments, this.segments, 1), ThreeUtil.getTypeSafe(this.heightSegments, this.segments, 1), ThreeUtil.getTypeSafe(this.depthRate, 1));
            } else {
          ...
          case 'ring':
            if (ThreeUtil.isNotNull(this.depth) && this.depth > 0) {
              geometry = new RingDepthGeometry(ThreeUtil.getTypeSafe(this.innerRadius, 0.5), ThreeUtil.getTypeSafe(this.outerRadius, 1), ThreeUtil.getTypeSafe(this.depth, 1), ThreeUtil.getTypeSafe(this.thetaSegments, 8), ThreeUtil.getTypeSafe(this.phiSegments, 1), ThreeUtil.getAngleSafe(this.thetaStart, 0), ThreeUtil.getAngleSafe(this.thetaLength, 360), ThreeUtil.getTypeSafe(this.depthRate, 1));
            } else {
              geometry = new THREE.RingBufferGeometry(ThreeUtil.getTypeSafe(this.innerRadius, 0.5), ThreeUtil.getTypeSafe(this.outerRadius, 1), ThreeUtil.getTypeSafe(this.thetaSegments, 8), ThreeUtil.getTypeSafe(this.phiSegments, 1), ThreeUtil.getAngleSafe(this.thetaStart, 0), ThreeUtil.getAngleSafe(this.thetaLength, 360));
            }
            break;
          ...
          case 'spherebuffer':
          case 'sphere':
            geometry = new THREE.SphereBufferGeometry(ThreeUtil.getTypeSafe(this.radius, 1), ThreeUtil.getTypeSafe(this.widthSegments, this.segments, 8), ThreeUtil.getTypeSafe(this.heightSegments, this.segments, 6), ThreeUtil.getAngleSafe(this.phiStart, 0), ThreeUtil.getAngleSafe(this.phiLength, 360), ThreeUtil.getAngleSafe(this.thetaStart, 0), ThreeUtil.getAngleSafe(this.thetaLength, 180));
            break;
          case 'tetrahedronbuffergeometry':
          case 'tetrahedrongeometry':
          case 'tetrahedronbuffer':
          case 'tetrahedron':
            geometry = new THREE.TetrahedronBufferGeometry(ThreeUtil.getTypeSafe(this.radius, 1), ThreeUtil.getTypeSafe(this.detail, 0));
            break;
          ...
          case 'torusknot':
            geometry = new THREE.TorusKnotBufferGeometry(ThreeUtil.getTypeSafe(this.radius, 1), ThreeUtil.getTypeSafe(this.tube, 0.4), ThreeUtil.getTypeSafe(this.radialSegments, this.radiusSegments, 64), ThreeUtil.getTypeSafe(this.tubularSegments, 8), ThreeUtil.getTypeSafe(this.p, 2), ThreeUtil.getTypeSafe(this.q, 3));
            break;
          ...
          case 'rollercoaster':
            geometry = new RollerCoaster.RollerCoasterGeometry(this.getCurve(), ThreeUtil.getTypeSafe(this.slices, 1500));
            break;
          case 'rollercoasterliftersgeometry':
          case 'rollercoasterlifters':
            geometry = new RollerCoaster.RollerCoasterLiftersGeometry(this.getCurve(), ThreeUtil.getTypeSafe(this.slices, 1500));
            break;
          case 'rollercoastershadowgeometry':
          case 'rollercoastershadow':
            geometry = new RollerCoaster.RollerCoasterShadowGeometry(this.getCurve(), ThreeUtil.getTypeSafe(this.slices, 1500));
            break;
          default:
            geometry = new THREE.PlaneBufferGeometry(ThreeUtil.getTypeSafe(this.width, this.height, 1), ThreeUtil.getTypeSafe(this.height, this.width, 1), ThreeUtil.getTypeSafe(this.widthSegments, this.segments, 1), ThreeUtil.getTypeSafe(this.heightSegments, this.segments, 1));
            break;
