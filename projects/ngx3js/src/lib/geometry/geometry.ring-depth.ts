 ...
 *
 * See the [ngx3js docs](https://outmindkjg.github.io/ngx3js-doc/#/docs/ngxapi/en/RingDepthGeometry) page for details.
...
export class RingDepthGeometry extends THREE.BufferGeometry {
	...
	constructor(
		...
		const frontGeometry = new THREE.RingBufferGeometry(
			innerRadius,
			outerRadius,
			thetaSegments,
			phiSegments,
