...
var agree = readline.question("Do you want to check out " + 'angular.json'.red +' , ' + 'package.json'.red + ', ' + 'tsconfig.json'.red+ "? (Y/N)\nThis program will change some json file for ngx3js.");
if (agree == 'Y') {
  const fs = require('fs');
    ...
    writeJson('package', packageJson, null, function() {
      ...
      writeJson('tsconfig', tsconfigJson, 'To learn more about this file see: https://angular.io/config/tsconfig.', function() {
        ...
        writeJson('angular', angularJson, null, function()  {
          ...
          console.log('\n'+'Thank You'.red+' for your agree.\n\n');
        })
      });
    });
  })();
} else {
  console.log('README - https://github.com/outmindkjg/ngx3js-module#usage');
  console.log('Read the page to use ngx3js');
  console.log('\n'+'Thank You'.red+'.\n\n');
}
